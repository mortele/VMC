...
void Atom::findAtomSize() {
    ...
    // Find size in pm.
    if      (m_charge == 1)  m_size = 53;
    else if (m_charge == 2)  m_size = 31;
    else if (m_charge == 3)  m_size = 167;
    else if (m_charge == 4)  m_size = 112;
    else if (m_charge == 5)  m_size = 87;
    else if (m_charge == 6)  m_size = 67;
    else if (m_charge == 7)  m_size = 56;
    else if (m_charge == 8)  m_size = 48;
    else if (m_charge == 9)  m_size = 42;
    else if (m_charge == 10) m_size = 38;
    else if (m_charge == 11) m_size = 190;
    else if (m_charge == 12) m_size = 145;
    else if (m_charge == 13) m_size = 118;
    else if (m_charge == 14) m_size = 111;
    else if (m_charge == 15) m_size = 98;
    else if (m_charge == 16) m_size = 88;
    else if (m_charge == 17) m_size = 79;
    else if (m_charge == 18) m_size = 71;
...
string Atom::findAtomName() {
    if 	    (m_charge == 1)   m_atomName = "H";
    else if (m_charge == 2)   m_atomName = "He";
    else if (m_charge == 3)   m_atomName = "Li";
    else if (m_charge == 4)   m_atomName = "Be";
    else if (m_charge == 5)   m_atomName = "B";
    else if (m_charge == 6)   m_atomName = "C";
    else if (m_charge == 7)   m_atomName = "N";
    else if (m_charge == 8)   m_atomName = "O";
    else if (m_charge == 9)   m_atomName = "F";
    else if (m_charge == 10)  m_atomName = "Ne";
    else if (m_charge == 11)  m_atomName = "Na";
    else if (m_charge == 12)  m_atomName = "Mg";
    else if (m_charge == 13)  m_atomName = "Al";
    else if (m_charge == 14)  m_atomName = "Si";
    else if (m_charge == 15)  m_atomName = "P";
    else if (m_charge == 16)  m_atomName = "S";
    else if (m_charge == 17)  m_atomName = "Cl";
    else if (m_charge == 18)  m_atomName = "Ar";
    return m_atomName;
}
