...
private:
    ...
    double   m_currentEnergy_JastrowDerivative    = 0;
    double   m_currentJastrowDerivative           = 0;
    double   m_cumulativeEnergy_JastrowDerivative = 0;
    double   m_cumulativeJastrowDerivative        = 0;
    double   m_energyJastrowDerivative            = 0;
    double   m_jastrowDerivative                  = 0;
